...
export default function Registro({
  ...
  onAddReg, onUpdateReg, onUploadRegPhoto, onHardDeleteReg, onAddClient, onAddContratoArchivo, onDeleteContratoArchivo, onUpdateContrato, goToClient,
}) {
              ...
              return (
                <tr key={r.id} onClick={()=>setSelectedRow(isSel?null:r.id)}
                  ...
                  <td style={td}>{(() => {
                    ...
                    return linked
                      ? linked.erronea
                        ? <span style={{ fontSize:10, fontWeight:700, color:C.red, background:C.red+"15", padding:"2px 8px", borderRadius:6 }}>Ficha erronea</span>
