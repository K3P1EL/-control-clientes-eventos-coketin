      ...
      <div className="flex gap-1 overflow-x-auto py-1">
        {TABS.map(t => (
          <button key={t.id} onClick={() => setActiveTab(t.id)}
            className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap transition-all ${activeTab === t.id ? "bg-sky-500/15 text-sky-400 border border-sky-500/30" : "text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800/50 border border-transparent"}`}>
