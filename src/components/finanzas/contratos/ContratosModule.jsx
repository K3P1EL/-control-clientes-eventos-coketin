...
export default function ContratosModule({ filterSem, filterMes, setQuickAll, setQuickWeek, setQuickMonth, prodTags = [], sendToCaja }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {editContract !== undefined && (
        <ContractModal contract={editContract} onSave={handleSave} onClose={() => setEditContract(undefined)} nextId={nextContractId} prodTags={prodTags} sendToCaja={sendToCaja} />
      )}
      {deleteId && (
