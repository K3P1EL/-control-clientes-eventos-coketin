...
// Metrics breakdown table: Yape/Efectivo × Negocio/Externo × Contrato/
// Fuera, plus traspasos and reconciliation with contract sueldos/
// servicios. Pure presentation — `desglose` comes from useCajaDesglose.
  ...
  return (
    <div style={cDark.card}>
      ...
      {(desglose.sueldoOut > 0 || desglose.servicioOut > 0) && (
        <div style={{ padding: 16, borderTop: "2px solid rgba(63,63,70,0.4)" }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#a1a1aa", marginBottom: 10 }}>📐 Conciliación con Contratos</div>
