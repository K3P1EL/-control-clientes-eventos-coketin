            ...
            {filtered.length === 0 ? (
              ...
              return (
                <tr key={e.id} style={{ borderBottom: "1px solid rgba(63,63,70,0.3)", background: isEditing ? "rgba(14,165,233,0.08)" : "transparent" }}
                  ...
                  <td style={{ padding: "10px 14px" }}>{e.gastoAjeno ? <DarkBadge color="yellow">💰 Ajeno</DarkBadge> : e.delNegocio !== false ? (e.deContrato ? <DarkBadge color="purple">📋 Contrato</DarkBadge> : <DarkBadge color="neutral">Fuera</DarkBadge>) : null}</td>
